...
writeLines(paste(
    '(Intercept)',beta[1], S_b0, t_b0, p_b0,
    '\n x         ',beta[2], S_b1, t_b1, p_b1,
    '\n sexo      ',beta[3], S_b2, t_b2, p_b2,
    "\n\n Residual standard error:",S,"en",n-p-1,"grados de libertad",
    "\n Multiple R-squared:",R2,"Adjusted R-squared:",R2c,
    "\n F-statistic:", Fvalor,"on",p,"and",n-p-1,"DF,  p-value:",p_valor))
